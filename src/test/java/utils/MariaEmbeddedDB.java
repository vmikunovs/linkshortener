...
public class MariaEmbeddedDB {
    ...
    public String getFullUrl(){
        return String.format("%s:%s/%s", dbUrl, dbPort, dbSchema);
      //  return String.format("%s:%s/%s%s", dbUrl, dbPort, dbSchema,"?useSSL=false&allowPublicKeyRetrieval=true");
    }
    ...
    private EntityManager createEntityManager() {
        ...
        for (BeanDefinition bd : scanner.findCandidateComponents("com.neueda.app.linkshortener")){
    ...
    public static final class Builder {
        ...
        private String dbSchema = "link_shortener";
